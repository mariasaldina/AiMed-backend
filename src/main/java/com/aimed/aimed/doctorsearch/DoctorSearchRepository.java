...
public class DoctorSearchRepository {
    ...
    public List<DoctorWithSimilarity> findTopDoctors(
        ...
        parameterSource.addValue("specializationIds", specializationIds);
        ...
        StringBuilder sql = new StringBuilder(
            ...
            WHERE EXISTS (
                ...
                WHERE ds.doctor_id = d.user_id AND ds.specialization_id IN (:specializationIds)
            )
            """
        );
